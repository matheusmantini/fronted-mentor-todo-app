...
function createElement(value, id, isCompleted) {
  ...
  editBtn.addEventListener("click", (e) => {
    ...
    submitBtn.innerHTML = '<i style="outline: none;border: none; background-color: transparent;     color: rgb(63, 126, 253); display: flex; align-items: center; padding: 6px 1px; border-radius: 50%; font-size: 12px; cursor: pointer;" class="fas fa-check"></i>';
  });
